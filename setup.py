...
try:
    with open(
        path.join(here, "src/enerbitdso/VERSION"), encoding="utf-8"
    ) as version_file:
...
setup(
    ...
    #
    # $ pip install enerbitcoreclient
    #
    # And where it will live on PyPI: https://pypi.org/project/enerbitcoreclient/
    #
